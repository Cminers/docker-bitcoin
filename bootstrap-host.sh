...
BTC_IMAGE=${BTC_IMAGE:-cminers/docker-bitcoin}
...
curl https://raw.githubusercontent.com/Cminers/docker-bitcoin/master/upstart.init > /etc/init/docker-bitcoind.conf
